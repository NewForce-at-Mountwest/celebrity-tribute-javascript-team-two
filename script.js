...
// console.log(newsy)
// document.querySelector("#nf").innerHTML= newsy
...
// document.querySelector("#es").innerHTML = `${country}${knownCollabs}${aliasesString}${image}`
...
//  document.querySelector("#extras-report").innerHTML = BFstring
 ...
 document.querySelector("#es").addEventListener("click", () => {
  //  const execSummary = `${country}${knownCollabs}${aliasesString}${image}`;
  //  console.log(execSummary);
   document.querySelector("#section").innerHTML = `${country}${knownCollabs}${aliasesString}${image}`
   
  })
  
document.querySelector("#pl").addEventListener("click", () => {
   document.querySelector("#section").innerHTML = `<H2>${shortIntroHTML}</h2>${personalKids}${personalPets}${personalParents}`
   
  })

document.querySelector("#nf").addEventListener("click", () => {
    document.querySelector("#section").innerHTML = newsy
    
   })

document.querySelector("#cr").addEventListener("click", () => {
    document.querySelector("#section").innerHTML = `<H2>${linData.career.shortIntro}</h2>${musicalsString}${rolesString}${songsString}${awardsString}`
    
   })

document.querySelector("#er").addEventListener("click", () => {
    document.querySelector("#section").innerHTML = BFstring
